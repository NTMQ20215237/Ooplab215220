...
public void  display() {
...
else
	{
		for (int i=0;i<qtyOrdered;i++)
			{
			System.out.println("Name:"+ itemOrdered[i].getTitle()+";Category:"+itemOrdered[i].getCategory()+"; Director: " + itemOrdered[i].getDirector() +
			
            		"; Length: " + itemOrdered[i].getLength() + "; Cost: " + itemOrdered[i].getCost());
	}
  }
}
