...
//	constructor
	...
	public JSONObject toJsonObject() {
		...
		jsonObject.put(Constant.ENTITY_ID,this.getId());
		jsonObject.put(Constant.ENTITY_NAME,this.getName());
		jsonObject.put(Constant.ENTITY_DESCRIPTION,this.getDescription());
		jsonObject.put(Constant.ENTITY_ADDITIONAL_INFO,this.getAdditionalInfo());
		jsonObject.put(Constant.ENTITY_RELATED_ENTITY_IDS,this.getRelatedEntityIds());
		jsonObject.put(Constant.ENTITY_TYPE,this.getType());
		jsonObject.put(Constant.ENTITY_ROOT_URL,this.getRootURL());
		return jsonObject;
	}
}